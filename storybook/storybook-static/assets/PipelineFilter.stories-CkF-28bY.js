import{r as d}from"./reference-DlgtBAY_.js";const f={title:"Components/PipelineFilter",parameters:{docs:{description:{component:`**Production reference:** [pipeline](https://www.abbvie.com/science/pipeline.html)

Pipeline compound cards with 3-column grid: metadata (left) | phase progress bars (center) | expand button (right). Click + to reveal description. Phase bars show filled (navy) vs empty (gray) progress.`}}}};function o(i){i.querySelectorAll(".pipeline-filter__expand-btn").forEach(e=>{e.addEventListener("click",()=>{const p=e.closest(".pipeline-filter__card").querySelector(".pipeline-filter__card-details").classList.toggle("expanded");e.textContent=p?"−":"+",e.setAttribute("aria-expanded",p)})})}const n=(i,e,s)=>`
  <div class="pipeline-filter__phase-bar pipeline-filter__phase-bar--filled" style="margin:0 2px;"></div>
  <div class="pipeline-filter__phase-bar pipeline-filter__phase-bar--${e?"filled":"empty"}" style="margin:0 2px;"></div>
  <div class="pipeline-filter__phase-bar pipeline-filter__phase-bar--${s?"filled":"empty"}" style="margin:0 2px;"></div>
`,a=()=>{const i=document.createElement("div");return i.innerHTML=d([{label:"Pipeline",url:"https://www.abbvie.com/science/pipeline.html"}])+`
  ...
  `,o(i),i};var l,t,r;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`() => {
  ...
  attachPipelineJS(el);
  return el;
}`,...(r=(t=a.parameters)==null?void 0:t.docs)==null?void 0:r.source}}};const h=["Default"];export{a as Default,h as __namedExportsOrder,f as default};

import{r as d}from"./reference-DlgtBAY_.js";const w={title:"Components/VideoEmbed",parameters:{docs:{description:{component:`**Production reference:** [homepage](https://www.abbvie.com/) (Parkinson's Research video — Watch 3:49), [science](https://www.abbvie.com/science.html) (research videos), [story articles](https://www.abbvie.com/who-we-are/our-stories/three-ways-ai-is-changing-drug-discovery-at-abbvie.html) (inline article video)

Video player with poster image, play button, and duration badge. StandaloneVideo: full block with title + description. InlineVideo: embedded in article body. Click play replaces poster with actual video. Found on 83 pages.`}}}},n=()=>{const e=document.createElement("div");e.style.maxWidth="640px",e.innerHTML=d([{label:"Homepage",url:"https://www.abbvie.com/"}])+`
  ...
  `;const o=e.querySelector(".video-embed-play-button"),t=e.querySelector(".video-embed-poster"),i=e.querySelector(".video-embed-player"),a=e.querySelector(".video-embed-duration");return o.addEventListener("click",()=>{t.style.display="none",o.style.display="none",a.style.display="none",i.style.display="block",i.play()}),e},r=()=>{const e=document.createElement("div");e.style.maxWidth="480px",e.innerHTML=d([{label:"Story Article",url:"https://www.abbvie.com/who-we-are/our-stories/three-ways-ai-is-changing-drug-discovery-at-abbvie.html"}])+`
  ...
  `;const o=e.querySelector(".video-embed-play-button"),t=e.querySelector(".video-embed-poster"),i=e.querySelector(".video-embed-player"),a=e.querySelector(".video-embed-duration");return o.addEventListener("click",()=>{t.style.display="none",o.style.display="none",a.style.display="none",i.style.display="block",i.play()}),e},s=()=>{const e=document.createElement("div");return e.innerHTML=d([{label:"Homepage (Parkinson's video)",url:"https://www.abbvie.com/"}])+`
  ...
  `,e};var l,p,c;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`() => {
  ...
  return wrapper;
}`,...(c=(p=n.parameters)==null?void 0:p.docs)==null?void 0:c.source}}};var m,v,b;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`() => {
  const wrapper = document.createElement('div');
  ...
  return wrapper;
}`,...(b=(v=r.parameters)==null?void 0:v.docs)==null?void 0:b.source}}};var y,u,h;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`() => {
  const wrapper = document.createElement('div');
  wrapper.innerHTML = refBanner([{
  ...
  \`;
  return wrapper;
}`,...(h=(u=s.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};const g=["StandaloneVideo","InlineVideo","TwoColumnWithOverlay"];export{r as InlineVideo,n as StandaloneVideo,s as TwoColumnWithOverlay,g as __namedExportsOrder,w as default};
